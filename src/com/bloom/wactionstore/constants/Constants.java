...
public final class Constants
{
  ...
  public static final String WACTIONSTORE_SCHEMA_NAME = "/WActionStore.json";
  public static final String WACTIONSTORE_QUERY_SCHEMA_NAME = "/WActionStoreQuery.json";
  public static final char WACTIONSTORE_TYPENAME_SEPARATOR = ':';
  public static final char WACTIONSTORE_NAME_SEPARATOR = '.';
  public static final String WACTION_CONTEXT = "context";
  public static final String WACTION_CONTEXT_NAME = "name";
  public static final String WACTION_CONTEXT_TYPE = "type";
  public static final String WACTION_CONTEXT_INDEX = "index";
  public static final String WACTION_CONTEXT_NULLABLE = "nullable";
  public static final String WACTION_METADATA = "metadata";
  public static final String WACTION_METADATA_ID = "id";
  public static final String WACTION_METADATA_TIMESTAMP = "timestamp";
  public static final String WACTION_METADATA_TIME_TO_LIVE = "ttl";
  public static final String WACTION_METADATA_ROUTING = "routing";
  public static final String WACTION_METADATA_CHECKPOINT_ID = "checkpoint";
  public static final String WACTION_METADATA_ANY = "any";
  public static final String WACTION_EVENT_TYPES = "events";
  public static final String WACTION_EVENT_NAME = "name";
  public static final String WACTION_EVENT_TYPE = "type";
  public static final String WACTION_TYPE_STRING = "string";
  public static final String WACTION_TYPE_TEXT = "text";
  public static final String WACTION_TYPE_BINARY = "binary64";
  public static final String WACTION_TYPE_BOOLEAN = "boolean";
  public static final String WACTION_TYPE_INTEGER = "integer";
  public static final String WACTION_TYPE_LONG = "long";
  public static final String WACTION_TYPE_DOUBLE = "double";
  public static final String WACTION_TYPE_DATE = "date";
  public static final String WACTION_TYPE_TIME = "time";
  public static final String WACTION_TYPE_DATETIME = "datetime";
  public static final String WACTION_CONTEXT_ID = "$id";
  public static final String WACTION_CONTEXT_TIMESTAMP = "$timestamp";
  public static final String WACTION_CONTEXT_NODE_NAME = "$node_name";
  public static final String WACTION_CONTEXT_CHECKPOINT_SEQ = "$checkpoint";
  ...
  public static final String ES_TYPE_OBJECT = "object";
  public static final String ES_TYPE_NESTED = "nested";
  public static final String ES_STRING_INDEX = "index";
  public static final String ES_STRING_INDEX_SIMPLE = "not_analyzed";
  ...
  public static final String ES_DATE_FORMAT_DATETIME = "basic_date_time";
  public static final String ES_METADATA_ID = "_id";
  public static final String ES_METADATA_TIMESTAMP = "_timestamp";
  public static final String ES_METADATA_TIME_TO_LIVE = "_ttl";
  public static final String ES_METADATA_ROUTING = "_routing";
  ...
  public static final String ES_SETTING_INDEX_COMPRESS = "index.store.compress";
  ...
  public static final String ES_SETTING_FLUSH_THRESHOLD_OPS = "index.translog.flush_threshold_ops";
  public static final String ES_SETTING_FLUSH_THRESHOLD_PERIOD = "index.translog.flush_threshold_period";
  ...
  public static final String ES_SETTING_MULTICAST_ENABLED = "discovery.zen.ping.multicast.enabled";
  ...
  public static final String ES_INDEX_STORE_TYPE_DISK = "default";
  ...
  public static final String CLUSTER_NAME_PROPERTY = "com.bloom.config.clusterName";
  public static final String ES_HTTP_ENABLED_PROPERTY = "com.bloom.config.es.http.enabled";
  ...
  public static final String WACTIONSTORE_PROVIDER_NAME = "storageProvider";
  public static final String WACTIONSTORE_PROVIDER_ELASTICSEARCH = "elasticsearch";
  public static final String WACTIONSTORE_PROVIDER_BLOOM_ELASTICSEARCH = "bloom_elasticsearch";
  public static final String WACTIONSTORE_RELAX_SCHEMA = "elasticsearch.relax_schema";
  public static final String WACTIONSTORE_DEFAULT_PROVIDER = "elasticsearch";
  public static final String WACTIONSTORE_PROVIDER_JDBC = "jdbc";
  public static final String WACTIONSTORE_PROVIDER_INMEMORY = "inmemory";
  public static final String WACTIONSTORE_UNKNOWN_PROVIDER = "<Unknown>";
  public static final String WACTIONSTORE_JDBC_INTERVAL = "persistence_interval";
  public static final String WACTIONSTORE_JDBC_INTERVAL_REGEX = "(\\s*)([0-9]+)(\\s+)(sec.*|min.*)";
  ...
  public static final String ELASTICSEARCH_INDEX_FLUSH_THRESHOLD_OPS = "elasticsearch.flush_interval";
  public static final String ELASTICSEARCH_INDEX_FLUSH_SIZE = "elasticsearch.flush_size";
  public static final String ELASTICSEARCH_INDEX_FLUSH_THRESHOLD_PERIOD = "elasticsearch.flush_threshold_period";
  public static final String ELASTICSEARCH_STORE_COMPRESS = "elasticsearch.compress";
  public static final String ELASTICSEARCH_INDEX_MERGE_NUM_THREADS = "elasticsearch.merge_num_threads";
  public static final String ELASTICSEARCH_INDEX_MERGE_POLICY_TYPE = "elasticsearch.merge_type";
  public static final String ELASTICSEARCH_INDEX_MERGE_POLICY_MERGE_FACTOR = "elasticsearch.merge_factor";
  ...
  public static final String ELASTICSEARCH_INTIAL_TIME_TO_WAIT_UNTIL_INDEX_IS_READY_STRING = System.getProperty("com.bloom.config.ESIndexWaitTimeForRecovery", "2");
  public static final long ELASTICSEARCH_INTIAL_TIME_TO_WAIT_UNTIL_INDEX_IS_READY = Long.valueOf(ELASTICSEARCH_INTIAL_TIME_TO_WAIT_UNTIL_INDEX_IS_READY_STRING).longValue();
  public static final String BLOOM_ES_TIME_TO_LIVE = "bloom_elasticsearch.time_to_live";
  public static final String SEARCH_ALIAS = "search_alias_";
  public static final String IsEsRollingIndexEnabled = System.getProperty("com.bloom.config.isRollingIndexEnabled", "true");
  ...
  public static final String CHECKPOINT_WACTIONSTORE_NAME = "WActionStoreName";
  public static final String CHECKPOINT_WACTION_COUNT = "WActionCount";
  ...
  public static final String CHECKPOINT_SCHEMA = "{  \"context\": [     { \"name\": \"$id\", \"type\": \"string\", \"nullable\": false },    { \"name\": \"$timestamp\", \"type\": \"datetime\", \"nullable\": false },    { \"name\": \"NodeName\", \"type\": \"string\", \"nullable\": false },    { \"name\": \"WActionStoreName\", \"type\": \"string\", \"nullable\": false },    { \"name\": \"WActionCount\", \"type\": \"long\", \"nullable\": false },    { \"name\": \"PathCount\", \"type\": \"long\", \"nullable\": false },    { \"name\": \"Paths\", \"type\": \"binary64\", \"nullable\": false }  ],  \"metadata\": [ \"id\", \"timestamp\" ]}";
  public static final String CHECKPOINT_QUERY = "{ \"select\":[ \"Paths\" ],  \"from\":  [ \"$Internal.CHECKPOINT\" ],  \"where\":   { \"oper\": \"eq\",    \"attr\": \"WActionStoreName\",    \"value\": \"%s\" } },  \"orderby\": [    { \"attr\": \"$timestamp\", \"ascending\": true }  ]}";
  public static final String CHECKPOINT_TIMESTAMP_QUERY = "{ \"select\":[ \"$timestamp\" ],  \"from\":  [ \"$Internal.CHECKPOINT\" ],  \"where\": {     \"and\": [    { \"oper\": \"eq\",      \"attr\": \"NodeName\",      \"value\": \"%s\" },    { \"oper\": \"eq\",      \"attr\": \"WActionStoreName\",      \"value\": \"%s\" }    ]  }}";
  public static final String CHECKPOINT_DELETE = "{ \"delete\": [ \"*\" ],  \"from\":  [ \"$Internal.CHECKPOINT\" ],  \"where\": {     \"oper\": \"eq\",    \"attr\": \"WActionStoreName\",    \"value\": \"%s\" }}";
  public static final String INVALID_WACTION_DELETE = "{ \"delete\": [ \"*\" ],  \"from\":  [ \"%s\" ],  \"where\": {     \"and\": [    { \"oper\": \"eq\",      \"attr\": \"$node_name\",      \"value\": \"%s\" },    { \"oper\": \"gt\",      \"attr\": \"$checkpoint\",      \"value\": %d }    ]  }}";
}
