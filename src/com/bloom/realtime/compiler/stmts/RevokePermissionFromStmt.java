...
public class RevokePermissionFromStmt
  extends Stmt
  implements SecurityStmt
{
  ...
  public RevokePermissionFromStmt(@NotNull List<ObjectPermission.Action> listOfPrivilege, @Nullable List<ObjectPermission.ObjectType> objectType, @NotNull String name, @Nullable String userorpermissionname, EntityType what)
  {
    this.towhat = what;
